...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public ApiResponse<ActivityLogRes.shareActivity> shareActivityLog(Long logId, Long userId) {
        ...
        assignmentRepository.findById(activityLog.getAssignment().getId()).ifPresent(assignment -> {
            assignment.setStatus(Status.ONGOING);
            assignmentRepository.save(assignment);
        });

        return ApiResponse.onSuccess(ActivityLogRes.shareActivity.builder()
